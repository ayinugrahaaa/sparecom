    ...
    if (isset($_SESSION['items'])) {
        foreach ($_SESSION['items'] as $key => $val) {
            ...
            ?>
                ...
                <td><center><a href="cart.php?act=plus&amp;barang_id=<?php echo $key; ?>&amp;ref=user.php?detail" class="btn btn-xs btn-success">Tambah</a> <a href="cart.php?act=min&amp;barang_id=<?php echo $key; ?>&amp;ref=user.php?detail" class="btn btn-xs btn-warning">Kurang</a> <a href="cart.php?act=del&amp;barang_id=<?php echo $key; ?>&amp;ref=user.php?detail" class="btn btn-xs btn-danger">Hapus</a></center></td>
                </tr>
				...
				if($total == 0){
					...
					echo '<p><div align="right">
						<a href="user.php?produk" class="btn btn-info btn-lg">&laquo; Continue Shopping</a>
						</div></p>';
				} else {
					echo '
						...
						<p><div align="right">
						<a href="user.php?produk" class="btn btn-info">&laquo; CONTINUE SHOPPING</a>
