    ...
    if (isset($_SESSION['items1'])) {
        foreach ($_SESSION['items1'] as $key => $val) {
			...
			<?php	}
                ...
                <p><div align="right">
						<a href="index.php?detail" class="btn btn-success">&raquo Details Keranjang &laquo</a>
						</div></p>
            </div>
      		<!-- start: Row -->
...
?>
        		<!--<div class="span4">-->
					...
					<!--	<p>
                        ...
                        <td></td>
                        <td></td>
						<td><div class="clear"> <a href="cart1.php?act=add&amp;barang_id=<?php echo $data['br_id']; ?>&amp;ref=index.php?detail" class="btn btn-lg btn-success">Beli &raquo;</a></div></td>
                        </tr>
